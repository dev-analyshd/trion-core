...
CHANNELS: Dict[int, CommunicationChannel] = {
    ...
    9: CommunicationChannel(
        ...
        status=ChannelStatus.ACTIVE,
        impl_paths=["indexers/crates/trion-common/src/event_types.rs",
    ...
    10: CommunicationChannel(
        ...
        status=ChannelStatus.ACTIVE,
        impl_paths=["anima-service/faiss_service.py"],
    ...
    12: CommunicationChannel(
        ...
        status=ChannelStatus.ACTIVE,
        impl_paths=["indexers/crates/trion-common/src/hash_dna.rs",
                    "src/security/genomic_genealogy.py"],
