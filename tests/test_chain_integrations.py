...
INDEXER_FILES = [
    ...
    ("rust-indexers/crates/trion-evm/src/main.rs",       "EVM Rust L0 indexer (9 EVM chains)"),
    # Native VMs — Rust L0 binaries
    ("rust-indexers/crates/trion-near/src/main.rs",      "NEAR Rust L0 indexer"),
    ("rust-indexers/crates/trion-ton/src/main.rs",       "TON Rust L0 indexer"),
    ("rust-indexers/crates/trion-pvm/src/main.rs",       "Polkadot PVM Rust L0 indexer"),
    ("rust-indexers/crates/trion-starknet/src/main.rs",  "StarkNet Rust L0 indexer"),
    # Extended VMs — Rust L0 binaries
    ("rust-indexers/crates/trion-cosmos/src/main.rs",    "Cosmos SDK Rust L0 indexer"),
    ("rust-indexers/crates/trion-utxo/src/main.rs",      "UTXO Rust L0 indexer"),
    ("rust-indexers/crates/trion-aptos/src/main.rs",     "Aptos Move Rust L0 indexer"),
    ("rust-indexers/crates/trion-sui/src/main.rs",       "Sui Rust L0 indexer"),
    ("rust-indexers/crates/trion-tron/src/main.rs",      "TRON Rust L0 indexer"),
    ("rust-indexers/crates/trion-pi/src/main.rs",        "Pi Network Rust L0 indexer"),
...
def test_chain_behavioral_dimensions_documented(crate, chain_label):
    ...
    src = (ROOT / "rust-indexers/crates" / crate / "src/main.rs").read_text()
