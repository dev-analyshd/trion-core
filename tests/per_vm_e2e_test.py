...
VM_ENTITIES = [
    ...
    ("COSMOS",    10000, "Cosmos entity",   "cosmos1trionentity"),
    ("COSMWASM",  10002, "Juno entity",     "juno1trionentity"),
    ("MOVE",      20000, "Aptos entity",    "0x742d35cc6634c0532925a3b844bc454e4438f44e"),
    ("SUI",       20100, "Sui entity",      "0x742d35cc6634c0532925a3b844bc454e4438f44e01"),
    ("UTXO",      21000, "Bitcoin entity",  "bc1qtrionentity"),
    ("TON",       22000, "TON entity",      "EQCDtrionentity"),
    ("NEAR",      23000, "NEAR entity",     "trion-entity.near"),
    ("STARKNET",  24000, "Starknet entity", "0x742d35cc6634c0532925a3b844bc454e4438f44e0123"),
    ("TRON",      26000, "TRON entity",     "TR7NHqjeKQxGTCi8q8ZY4pL8otSzgjLj6t"),
    ("STELLAR",   27000, "Stellar entity",  "GA5XIGA5C7QTPTWXQHY6MCJRMTRZDPSZVWT4D5NTPWAI6Z"),
    ("PVM",       25000, "Polkadot entity", "5GrwvaEF5zXb26Fz9rcQpDWS57CtERHpNehXCPcNoHGKut"),
    ("XRPL",      31000, "XRPL entity",     "rHb9CJAWyB4rj91VRWn96DkukG4bwdtyTh"),
    ("WAVES",     30000, "Waves entity",    "3P8dk2MDsYYb9CHA6g8DbjrD4EKW8KTbHWt"),
    ("VECHAIN",   29000, "VeChain entity",  "0x742d35cc6634c0532925a3b844bc454e4438f44f"),
    ("MULTIVERSX", 32000, "MultiversX entity", "erd1trionentity"),
    ("HEDERA",    28000, "Hedera entity",   "0.0.742d35"),
