  ...
  return (
    <div className="space-y-6">
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <StatCard label="Σ(t)" value={(sigma?.sigma || 0.25).toFixed(4)} color={sigma?.bootstrap ? 'amber' : 'green'} />
      ...
      <Card title="Validator Registry — Launch Threshold" live>
        <div className="text-center py-4">
          ...
          <div className="text-sm text-muted-foreground mt-2">validators registered (whitepaper §4 launch threshold)</div>
        </div>
...
export function BootstrapPage() {
  ...
  return (
    <div className="space-y-6">
      <Card title="Bootstrap Protocol — e^(-λ × D)" live>
        <div className="text-center py-4">
