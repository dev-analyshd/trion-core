...
CHAINS = [
    ...
    # ── Gap-filled: chains from shared manifest missing here (chain audit fix) ──
    ...
    {"id": "sei", "name": "Sei", "vm": "Cosmos SDK", "chain_id": 10005, "status": "indexed", "color": "#888888", "indexer": "trion-cosmos", "note": "gap-filled from shared manifest"},
    {"id": "dydx", "name": "dYdX", "vm": "Cosmos SDK", "chain_id": 10006, "status": "live", "color": "#888888", "indexer": "trion-cosmos", "note": "gap-filled from shared manifest"},
    ...
    {"id": "gnosis", "name": "Gnosis", "vm": "EVM", "chain_id": 100, "status": "live", "color": "#888888", "indexer": "trion-evm", "note": "gap-filled from shared manifest"},
    ...
    {"id": "fantom", "name": "Fantom", "vm": "EVM", "chain_id": 250, "status": "live", "color": "#888888", "indexer": "trion-evm", "note": "gap-filled from shared manifest"},
    ...
    {"id": "metis", "name": "Metis", "vm": "EVM", "chain_id": 1088, "status": "live", "color": "#888888", "indexer": "trion-evm", "note": "gap-filled from shared manifest"},
    {"id": "wemix", "name": "WEMIX", "vm": "EVM", "chain_id": 1111, "status": "indexed", "color": "#888888", "indexer": "trion-evm", "note": "gap-filled from shared manifest"},
    {"id": "core", "name": "Core", "vm": "EVM", "chain_id": 1116, "status": "indexed", "color": "#888888", "indexer": "trion-evm", "note": "gap-filled from shared manifest"},
    ...
    {"id": "cyber", "name": "Cyber", "vm": "EVM", "chain_id": 7560, "status": "indexed", "color": "#888888", "indexer": "trion-evm", "note": "gap-filled from shared manifest"},
    ...
    {"id": "iota-evm", "name": "Iota EVM", "vm": "EVM", "chain_id": 8822, "status": "indexed", "color": "#888888", "indexer": "trion-evm", "note": "gap-filled from shared manifest"},
    ...
    {"id": "mode", "name": "Mode", "vm": "EVM", "chain_id": 34443, "status": "live", "color": "#888888", "indexer": "trion-evm", "note": "gap-filled from shared manifest"},
    ...
    {"id": "bob", "name": "BOB", "vm": "EVM", "chain_id": 60808, "status": "indexed", "color": "#888888", "indexer": "trion-evm", "note": "gap-filled from shared manifest"},
    ...
    {"id": "zora", "name": "Zora", "vm": "EVM", "chain_id": 7777777, "status": "live", "color": "#888888", "indexer": "trion-evm", "note": "gap-filled from shared manifest"},
    ...
    {"id": "vechain", "name": "Vechain", "vm": "VET VM", "chain_id": 29000, "status": "indexed", "color": "#888888", "indexer": "trion-vechain", "note": "gap-filled from shared manifest"},
    ...
    {"id": "xrpl", "name": "XRPL", "vm": "XRP Ledger", "chain_id": 31000, "status": "indexed", "color": "#888888", "indexer": "trion-xrpl", "note": "gap-filled from shared manifest"},
