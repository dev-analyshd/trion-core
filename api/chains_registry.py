...
CHAINS = [
    ...
    {"id": "solana", "name": "Solana", "vm": "SVM", "chain_id": 900, "status": "live", "color": "#9945FF", "indexer": "trion-svm", "note": "chain_id re-pointed to canonical 900 per config/chain_registry.json (was 101 — local id colliding with legacy sui/fixture namespaces)"},
    {"id": "solana-dev", "name": "Solana Devnet", "vm": "SVM", "chain_id": 901, "status": "testnet", "color": "#9945FF", "indexer": "trion-svm", "bh_label": "SOLANA_DEVNET", "note": "chain_id re-pointed to canonical 901 per config/chain_registry.json (was 103)"},
    ...
    {"id": "sui", "name": "SUI", "vm": "Sui VM", "chain_id": 20100, "status": "live", "color": "#6FBCF0", "indexer": "trion-sui", "note": "chain_id re-pointed to canonical 20100 per config/chain_registry.json (was 0/unknown; matches the sui-mainnet gap-filled entry)"},
