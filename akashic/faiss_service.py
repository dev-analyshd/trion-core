...
INDEX_PATH     = _resolve_path("FAISS_INDEX_PATH",     ["akashic_faiss.index", "akashic/akashic_faiss.index"])
CENTROIDS_PATH = _resolve_path("FAISS_CENTROIDS_PATH", ["trion_archetype_centroids.npy", "akashic/trion_archetype_centroids.npy"])
