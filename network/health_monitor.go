...
var CHAINS = []Chain{
	...
	// Non-EVM Mainnet — chain ids are the canonical registry ids
	// (config/chain_registry.json: Solana Mainnet 900, NEAR Mainnet 23000,
	// TON Mainnet 22000; RPC urls below are the mainnet endpoints).
	{"SOLANA", 900, "https://api.mainnet-beta.solana.com", "SVM"},
	{"NEAR", 23000, "https://rpc.mainnet.fastnear.com", "NEAR"},
	{"TON", 22000, "https://toncenter.com/api/v2/jsonRPC", "TON"},
	// Services — internal. FAISS (anima-service/faiss_service.py) serves
	// /healthz, /health, /readyz, /stats; the Oracle api/app.py serves
	// /healthz, /readyz, /api/v1/health (NO bare /health — probing it
	// would 404 and report a healthy oracle as DEGRADED).
