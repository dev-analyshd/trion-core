...
//!
//! GAP-RUST additions (specification-mandated gaps closed):
//! - `master_equation` — L5 five-plane C(t), Θ(t), T(t) (specification §3;
...
// GAP-RUST: five-plane master equation (specification §3)
