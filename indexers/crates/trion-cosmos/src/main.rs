...
const CHAINS: &[CosmosChain] = &[
    ...
    CosmosChain { label: "OSMOSIS",    chain_id: 10001, denom: "uosmo",
        lcds: &["https://osmosis-api.polkachu.com", "https://osmosis.api.kjnodes.com",
                "https://rest.cosmos.directory/osmosis"] },
    CosmosChain { label: "JUNO",       chain_id: 10002, denom: "ujuno",
        lcds: &["https://juno-api.polkachu.com", "https://juno.api.kjnodes.com",
                "https://rest.cosmos.directory/juno"] },
    CosmosChain { label: "NEUTRON",    chain_id: 10003, denom: "untrn",
        lcds: &["https://neutron-api.polkachu.com", "https://neutron.api.kjnodes.com",
                "https://rest.cosmos.directory/neutron"] },
    CosmosChain { label: "CELESTIA",   chain_id: 10007, denom: "utia",
        lcds: &["https://celestia-api.polkachu.com", "https://celestia.api.kjnodes.com",
                "https://rest.cosmos.directory/celestia"] },
    CosmosChain { label: "AXELAR",     chain_id: 10008, denom: "uaxl",
        lcds: &["https://axelar-api.polkachu.com", "https://axelar.api.kjnodes.com",
                "https://rest.cosmos.directory/axelar"] },
    CosmosChain { label: "NOBLE",      chain_id: 10009, denom: "uusdc",
        lcds: &["https://noble-api.polkachu.com", "https://noble.api.kjnodes.com",
                "https://rest.cosmos.directory/noble"] },
    CosmosChain { label: "PERSISTENCE", chain_id: 10010, denom: "uxprt",
        lcds: &["https://persistence-api.polkachu.com", "https://persistence.api.kjnodes.com",
                "https://rest.cosmos.directory/persistence"] },
    CosmosChain { label: "KUJIRA",     chain_id: 10011, denom: "ukuji",
        lcds: &["https://kujira-api.polkachu.com", "https://kujira.api.kjnodes.com",
                "https://rest.cosmos.directory/kujira"] },
    CosmosChain { label: "COMDEX",     chain_id: 10012, denom: "ucmdx",
        lcds: &["https://comdex-api.polkachu.com", "https://comdex.api.kjnodes.com",
                "https://rest.cosmos.directory/comdex"] },
    CosmosChain { label: "CHIHUAHUA",  chain_id: 10013, denom: "uhuahua",
        lcds: &["https://chihuahua-api.polkachu.com", "https://chihuahua.api.kjnodes.com",
                "https://rest.cosmos.directory/chihuahua"] },
    CosmosChain { label: "STARGAZE",   chain_id: 10016, denom: "ustars",
        lcds: &["https://stargaze-api.polkachu.com", "https://stargaze.api.kjnodes.com",
                "https://rest.cosmos.directory/stargaze"] },
    CosmosChain { label: "REGEN",      chain_id: 10017, denom: "uregen",
        lcds: &["https://regen-api.polkachu.com", "https://regen.api.kjnodes.com",
                "https://rest.cosmos.directory/regen"] },
    CosmosChain { label: "UMEE",       chain_id: 10018, denom: "uumee",
        lcds: &["https://umee-api.polkachu.com", "https://umee.api.kjnodes.com",
