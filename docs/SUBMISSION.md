...
**Log Layer (Immutable Audit Trail):**
...
TRION's ANIMA engine classifies every on-chain entity into one of **10 behavioral archetypes**, each issued as a 0G Agent ID token:
...
| Metric | Value |
|---|---|
| Chains indexed | **129 registered / 40 integrated** (EVM, SVM, NEAR, TON, Move, Cosmos, PVM, SUI, StarkNet, UTXO, TVM, PI, Movement) |
| VM families | **18** |
...
|---|---|---|---|
| Ronin Bridge | $625M | GOVERNANCE_CAPTURE | **168 hours** |
| Wormhole Bridge | $325M | ANOMALOUS_BRIDGE_FLOW | 96 hours |
| Euler Finance | $197M | FLASH_LOAN_ATTACKER | 48 hours |
| Terra/LUNA | $40B | REFLEXIVITY_COLLAPSE | **312 hours** |
